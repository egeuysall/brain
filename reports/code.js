...
var ENCRYPTED_URL = "https://codehs.com/uploads/681003b01c9cf08e635f1918b715921a";
var DECRYPTED_URL = "https://codehs.com/uploads/61feadea94bbdb34769ea08c73cdb1bc";
...
function addLabels(){
    // Add original label
    var originalLabel = new Text("//-------------------- Original Image --------------------//", "14pt Arial");
    originalLabel.setPosition(image.getX(), LABEL_GAP);
    add(originalLabel);

    // Add message label
    var messageLabel = new Text("//-------------------- Secret Image --------------------//", "14pt Arial");
    messageLabel.setPosition(image.getX(),
            image.getY() + LABEL_GAP + IMAGE_HEIGHT);
    add(messageLabel);

    // Add encrypted label
    var encryptedLabel = new Text("//-------------------- Encrypted Image --------------------//", "14pt Arial");
    encryptedLabel.setPosition(image.getX(),
            image.getY() + LABEL_GAP + GAP + 2 * IMAGE_HEIGHT);
    add(encryptedLabel);

    // Add decrypted label
    var decryptedLabel = new Text("//-------------------- Decrypted Image --------------------//", "14pt Arial");
    decryptedLabel.setPosition(image.getX(),
