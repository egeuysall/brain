...
title: Thread 16 - deep review needs repo level context
description: >-
  The only plausible way to make code review agents work is to start from
  preloaded architecture context of the entire codebase, then inspect PR changes
  in that context. Without that, deep review quality collapses.
