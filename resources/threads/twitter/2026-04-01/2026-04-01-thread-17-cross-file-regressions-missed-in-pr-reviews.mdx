...
title: Thread 17 - cross file regressions missed in pr reviews
description: >-
  the repo-wide context is what makes this different. PR-level review misses the
  "this breaks something 3 files away" pattern I see constantly in AI-generated
  code.
