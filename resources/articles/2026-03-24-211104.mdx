...
Saved: 2026-03-24-211104

---

Title: Early Work

URL Source: https://paulgraham.com/early.html

Markdown Content:
![Image 1: Early Work](https://s.turbifycdn.com/aah/paulgraham/early-work-5.gif)October 2020
...
[[2](https://paulgraham.com/early.html#f2n)] If you use revenue as the test, Silicon Valley's optimism seems better tuned than the rest of the world's. And because it works, it will spread.
...
[[3](https://paulgraham.com/early.html#f3n)]
...
[[4](https://paulgraham.com/early.html#f4n)]
...
[[5](https://paulgraham.com/early.html#f5n)][[6](https://paulgraham.com/early.html#f6n)]
...
[[7](https://paulgraham.com/early.html#f7n)]
...
[Bel](https://paulgraham.com/bel.html). Having worked for so long with various dialects of Lisp, I was very curious to see what its inherent shape was: what you'd end up with if you followed the axiomatic approach all the way.
...
[[8](https://paulgraham.com/early.html#f8n)]
...
[1](https://paulgraham.com/early.html)] This assumption may be too conservative. There is some evidence that historically the Bay Area has attracted a [different sort of person](https://paulgraham.com/cities.html) than, say, New York City.
[

[2](https://paulgraham.com/early.html)] One of their great favorites is Theranos. But the most conspicuous feature of Theranos's cap table is the absence of Silicon Valley firms. Journalists were fooled by Theranos, but Silicon Valley investors weren't.
[

[3](https://paulgraham.com/early.html)] I made two mistakes about teachers when I was younger. I cared more about professors' research than their reputations as teachers, and I was also wrong about what it meant to be a good teacher. I thought it simply meant to be good at explaining things.
[

[4](https://paulgraham.com/early.html)] Patrick Collison points out that you can go past treating something as a hack in the sense of a prototype and onward to the sense of the word that means something closer to a practical joke:
...
[[5](https://paulgraham.com/early.html)] Much of the advantage of switching from physical to digital media is not the software per se but that it lets you start something new with little upfront commitment.
[

[6](https://paulgraham.com/early.html)] John Carmack adds:
...
[[7](https://paulgraham.com/early.html)] Lisa Randall suggests that we
...
[[8](https://paulgraham.com/early.html)] Michael Nielsen points out that the internet has made this easier, because you can see programmers' first commits, musicians' first videos, and so on.
