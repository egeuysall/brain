...
description: '[Armin Ronacher](https://lucumr.pocoo.org/about/)''s Thoughts and Writings'
date: '2026-03-21'
updatedAt: '2026-03-21T19:09:53.996Z'
---
Source: https://lucumr.pocoo.org/2026/3/20/some-things-just-take-time/

Saved: 2026-03-21-134327

---

Title: Some Things Just Take Time

URL Source: https://lucumr.pocoo.org/2026/3/20/some-things-just-take-time/

Published Time: 2026-03-20T00:00:00

Markdown Content:

# Some Things Just Take Time | Armin Ronacher's Thoughts and Writings

[Armin Ronacher](https://lucumr.pocoo.org/about/)'s Thoughts and Writings

- [blog](https://lucumr.pocoo.org/)
- [archive](https://lucumr.pocoo.org/archive/)
- [projects](https://lucumr.pocoo.org/projects/)
- [travel](https://lucumr.pocoo.org/travel/)
- [talks](https://lucumr.pocoo.org/talks/)
- [about](https://lucumr.pocoo.org/about/)
...
But there are things where speed is actively harmful, where the friction exists for a reason. Compliance is one of those cases. There’s a strong desire to eliminate everything that processes like SOC2 require, and an entire industry of turnkey solutions has sprung up to help — [Delve](https://substack.com/home/post/p-191342187) just being one example, there are more.
...
We recently [planted a new tree](https://earendil.com/) with Colin. I want it to grow into a large one. I know that’s going to take time, and I’m not in a rush.

This entry was tagged [ai](https://lucumr.pocoo.org/tags/ai/)

[copy as](https://lucumr.pocoo.org/2026/3/20/some-things-just-take-time.md) / [view](https://lucumr.pocoo.org/2026/3/20/some-things-just-take-time.md) markdown

© Copyright 2026 by Armin Ronacher.

Content licensed under the Creative Commons Attribution-NonCommercial 4.0 International [License](https://creativecommons.org/licenses/by-nc/4.0/).
...
More info: [imprint](https://lucumr.pocoo.org/about#imprint)&[AI transparency](https://lucumr.pocoo.org/ai-transparency). Subscribe via [atom](https://lucumr.pocoo.org/feed.atom "Armin Ronacher's
            Thoughts and Writings") / [RSS](https://lucumr.pocoo.org/feed.xml "Armin Ronacher's
